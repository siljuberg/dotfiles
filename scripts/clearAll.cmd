...
rem taskkill /IM "chrome.exe" /F >nul 2>nul
rem taskkill /IM "outlook.exe" /F >nul 2>nul

taskkill /IM "cmd.exe" /F >nul 2>nul
taskkill /IM "chrome.exe" /F"C:\Program Files (x86)\Google\Chrome\Application\chrome.exe"
