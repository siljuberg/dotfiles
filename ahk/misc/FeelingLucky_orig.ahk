...
If (Search <> "")
	...
	Else
		Run % DefaultBrowser A_Space "http://www.google.com/search?q=" EncodeURL(Search " site:wikipedia.org") "&btnI=1" ; Otherwise conduct an I'm Feeling Lucky search of the term on wikipedia
Return
